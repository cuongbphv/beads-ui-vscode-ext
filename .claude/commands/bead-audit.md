...
Nhóm bead theo mặt trận (code / UI / hạ tầng / docs) — mỗi nhóm 1 agent
(`Explore` cho repo-only, `general-purpose` khi cần chạm môi trường ngoài), chạy
song song. Prompt cho mỗi agent PHẢI có:
